...
const ManageBotTableRcs = ({ id, name }) => {
    const [selectedRows, setSelectedRows] = useState([]);
    const [paginationModel, setPaginationModel] = useState({ page: 0, pageSize: 10 });

    const columns = [
        { field: 'sn', headerName: 'S.No', flex: 0, minWidth: 80 },
        { field: 'botname', headerName: 'Bot Name', flex: 1, minWidth: 120 },
        { field: 'botid', headerName: 'Bot Id', flex: 1, minWidth: 120 },
        { field: 'createdon', headerName: 'Created on', flex: 1, minWidth: 120 },
        { field: 'assigntouser', headerName: 'Assign To User', flex: 1, minWidth: 120 },
    ...
    const rows = Array.from({ length: 20 }, (_, i) => ({
        ...
        sn: i + 1,
        botname: 'demobot',
        botid: 'user@example.com',
        createdon: '27/01/2024 14:58:39',
        assigntouser: 'Lorem ipsum dolor sit amet',
        status: 'pending',
    }));
