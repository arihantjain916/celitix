...
const SuggestionReportTableRcs = ({ id, name }) => {
    ...
    const columns = [
        ...
        { field: 'messagingtype', headerName: 'Messaging Type', flex: 1, minWidth: 120 },
        { field: 'message', headerName: 'Message', flex: 1, minWidth: 120 },
        { field: 'receivetime', headerName: 'Receive Time', flex: 1, minWidth: 120 },
    ];
