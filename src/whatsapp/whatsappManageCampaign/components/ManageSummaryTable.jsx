...
const ManageSummaryTable = ({ id, name, handleView, handleDuplicate, handleDelete }) => {
    ...
    const columns = [
        ...
        { field: 'user', headerName: 'Marketing', flex: 1, minWidth: 120 },
        { field: 'total', headerName: 'WhatsApp', flex: 1, minWidth: 120 },
        { field: 'busy', headerName: 'Utitlity', flex: 1, minWidth: 120 },
        { field: 'failed', headerName: 'Country Code', flex: 1, minWidth: 120 },
        { field: 'block', headerName: 'Display Name', flex: 1, minWidth: 120 },
